 ...
 static final List<BoardingModel> boardingList = [
    BoardingModel(
     // image: 'assets/images/beach.webp',
      image:'${Constants.kBeachImage}', //'assets/images/beach-sea-18378306.webp',
    ...
    BoardingModel(
      image: '${Constants.kTwoImage}', //'assets/images/2.jpeg',
      title: 'Privacy',
      body:
    ...
    BoardingModel(
      image:'${Constants.kThreeImage}', // 'assets/images/3.jpg',
    ...
    BoardingModel(
      image: '${Constants.koneImage}', //'assets/images/1.png',
